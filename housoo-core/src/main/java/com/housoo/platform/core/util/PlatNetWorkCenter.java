 ...
 *
 * @author John Zhang
 * @created 2017年6月16日 下午4:00:29
 */
public final class PlatNetWorkCenter {
     ...
     * 日志输出组件
     */
    private static final Logger LOG = LoggerFactory.getLogger(PlatNetWorkCenter.class);
    /**
     * 请求编码
     */
    ...
    public static Map<String, Object> post(String url, String paramData) {
        final Map<String, Object> response = new HashMap<String, Object>();
        post(url, paramData, new ResponseCallback() {
            @Override
            public void onResponse(int resultCode, String resultJson) {
                if (200 == resultCode) {
                    response.putAll((Map) JSON.parseObject(resultJson, Map.class));
                } else {//请求本身就失败了
    ...
    public static Map<String, Object> post(String url, String paramData, List<File> fileList) {
        final Map<String, Object> response = new HashMap<String, Object>();
        ...
        switch (method) {
            ...
            case POST:
                ...
                if (null != fileList && !fileList.isEmpty()) {
                    ...
                    if (null != paramData) {// 目前支持JSON格式的数据
