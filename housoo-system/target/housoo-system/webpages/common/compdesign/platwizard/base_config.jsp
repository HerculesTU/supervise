...
<jsp:include page='<%="/appmodel/DesignController/includeUI.do"%>' >
    <jsp:param value="platwizard" name="DESIGN_CODE"/>
</jsp:include>
<!-- 结束引入基本信息界面 -->

<script type="text/javascript">

function saveWizardBaseConfig(){
	var result = false;
	var wizardstepJson = PlatUtil.getEditTableAllRecordJson("wizardstep");
	var formData = PlatUtil.getFormEleData("BaseConfigForm");
	formData.wizardstepJson = wizardstepJson;
