...
<form method="post" class="form-horizontal" id="BaseConfigForm">
	...
	<div class="form-group">
		<plattag:select name="ASSOCIAL_FIELDNAME" auth_type="write" istree="true"
			...
			allowblank="true" placeholder="请选择关联字段" comp_col_num="3" 
	...
	<div class="hr-line-dashed"></div>
	<div class="form-group">
	    <plattag:radio name="IS_TREE"  value="${fieldInfo.IS_TREE}" auth_type="write" select_first="true" static_values="否:false,是:true"
		  allowblank="false" is_horizontal="true" label_col_num="1" label_value="是否树形" comp_col_num="3">
		</plattag:radio>
	    <plattag:input name="COMP_PLACEHOLDER" auth_type="write" allowblank="true"
	...
	<div class="hr-line-dashed"></div>
	<div class="form-group">
	    <plattag:radio name="IS_MULTIPLE"  value="${fieldInfo.IS_MULTIPLE}" auth_type="write" select_first="true" static_values="否:-1,是:1"
		  allowblank="false" is_horizontal="true" label_col_num="1" label_value="支持多选" comp_col_num="3">
		</plattag:radio>
	    <plattag:input name="MAX_SELECT_NUM" auth_type="write" allowblank="true" datarule="positiveInteger;"
			placeholder="只针对多选情况,允许最大选择数量" comp_col_num="3" label_col_num="1" value="${fieldInfo.MAX_SELECT_NUM}"
			maxlength="30" label_value="最大可选数量" >
		</plattag:input>
		<plattag:radio name="ONLYSELECTLEAF"  value="${fieldInfo.ONLYSELECTLEAF}" auth_type="write" select_first="true" static_values="否:false,是:true"
		  allowblank="true" is_horizontal="true" label_col_num="1" label_value="只能选叶子" comp_col_num="3">
		</plattag:radio>
	</div>
	<div class="hr-line-dashed"></div>
	<div class="form-group">
	    ...
	    <plattag:input name="COMP_COL_NUM" auth_type="write" allowblank="false" max="12" min="0" datarule="required;positiveInteger;"
	...
	<div class="form-group">
     ...
     <div id="DYNA_DIV" style="${fieldInfo.DATA_TYPE=='2'?'':'display: none;'}">
         <div class="form-group" >
          ...
          <div class="hr-line-dashed"></div>
	      <div class="form-group" >
	         <plattag:textarea name="DYNAPARAM" auth_type="write" allowblank="true" value="${fieldInfo.DYNAPARAM}" 
...
$(function(){
	...
	$("select[name='DYNAINTERFACE']").change(function() {
		...
		$("textarea[name='DYNAPARAM']").val(gencmptplCode);
	});
});
</script>
