...
<%
    ...
    commonUIService.saveDataTableBaseConfig(filter, fieldInfo);
%>
...
<div class="tabs-container" id="datatableAttachTab">
	<ul class="nav nav-tabs">
		...
		<li class=""><a data-toggle="tab" href="#tab-3"
			aria-expanded="false"><i class="fa fa-sort"></i>默认排序配置</a></li>
	...
	<div class="tab-content">
		...
		<div id="tab-3" class="tab-pane" >
		     <jsp:include page="/webpages/common/compdesign/jqgrid/order_form.jsp"></jsp:include>
		</div>
...
function saveJqGridAttachConfig(){
	if(PlatUtil.validBootstrapTab("datatableAttachTab")){
		...
		if(COLUMN_JSON!=null&&COLUMN_JSON!=""){
			...
			var ORDERFIELD_JSON = PlatUtil.getEditTableAllRecordJson("orderTable");
			...
			var formData = {
				...
				ORDERFIELD_JSON:ORDERFIELD_JSON,
