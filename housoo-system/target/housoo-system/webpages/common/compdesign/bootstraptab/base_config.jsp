...
<jsp:include page='<%="/appmodel/DesignController/includeUI.do"%>' >
    <jsp:param value="bootstraptabbaseconfig" name="DESIGN_CODE"/>
</jsp:include>
<!-- 结束引入基本信息界面 -->

<script type="text/javascript">

function saveTabBaseConfig(){
	var result = false;
	var tabConfigRows = PlatUtil.getEditTableAllRecord("tabConfig");
	var formData = PlatUtil.getFormEleData("BaseConfigForm");
	var tabConfigJson = JSON.stringify(tabConfigRows);
	formData.tabConfigJson = tabConfigJson;
