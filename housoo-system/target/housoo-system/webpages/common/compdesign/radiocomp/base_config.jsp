...
<form method="post" class="form-horizontal" id="BaseConfigForm">
	...
	<div class="hr-line-dashed"></div>
	<div class="form-group">
	    <plattag:radio name="SELECT_FIRST"  value="${fieldInfo.SELECT_FIRST}" auth_type="write" select_first="true" static_values="是:true,否:false"
		  allowblank="false" is_horizontal="true" label_col_num="1" label_value="默认选中首个" comp_col_num="3">
		</plattag:radio>
