...
<div class="titlePanel">
	<div class="title-search form-horizontal" id="tb_super_clazz_search" formcontrolid="4028819f71e8ad900171e8b3d4530013">
		<table>
			<tr>
				<td>查询条件</td>
...
function addJqGridRecordInfo(RECORD_ID){
	var url = "supervise/ClazzController.do?goForm&UI_DESIGNCODE=super_type_form";
	var title = "新增督办类型信息";
	if(RECORD_ID){
...
function delJqGridRecordInfo(){
	PlatUtil.operMulRecordForTable({
		...
		url:"supervise/ClazzController.do?multiDel",
...
$(function(){
	PlatUtil.initJqGrid({
		  ...
		  url: "appmodel/CommonUIController.do?tabledata&FORMCONTROL_ID=4028819f71e8ad900171e8b3d4530013",
