...
<html>
  ...
  <body>
   ...
   <div class="panel-Title">
	<h5 id="tb_supervise_item_datatablepaneltitle">督办事项分类</h5>
</div>
<div class="titlePanel">
	<div class="title-search form-horizontal" id="tb_supervise_item_search" formcontrolid="402881f6717243b30171724dedde0014">
		<table>
			<tr>
				<td>查询条件</td>
...
function addJqGridRecordInfo(RECORD_ID){
	var url = "supervise/SuperviseItemController.do?goForm&UI_DESIGNCODE=tb_supervise_item_form";
...
function delJqGridRecordInfo(){
	PlatUtil.operMulRecordForTable({
		...
		url:"supervise/SuperviseItemController.do?multiDel",
...
$(function(){
	PlatUtil.initJqGrid({
		  ...
		  url: "appmodel/CommonUIController.do?tabledata&FORMCONTROL_ID=402881f6717243b30171724dedde0014",
