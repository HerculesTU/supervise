...
<html>
  ...
  <body>
   ...
   <form method="post" class="form-horizontal" compcode="formcontainer" action="appmodel/PortalThemeController.do?saveOrUpdate" id="portalthemeform" style="">

  <input type="hidden" name="THEME_ID" value="${portalTheme.THEME_ID}">
<div class="form-group" compcode="formgroup">
   <plattag:input name="THEME_NAME" allowblank="false" auth_type="write" value="${portalTheme.THEME_NAME}" datarule="required;" maxlength="30" label_value="主题名称" placeholder="请输入主题名称" comp_col_num="10" label_col_num="2">
   </plattag:input>
</div>
...
function submitBusForm(){
	if(PlatUtil.isFormValid("#portalthemeform")){
		var url = $("#portalthemeform").attr("action");
		var formData = PlatUtil.getFormEleData("portalthemeform");
