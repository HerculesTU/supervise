...
<html>
  ...
  <body>
   ...
   <form method="post" class="form-horizontal" compcode="formcontainer" action="supervise/SourceController.do?saveOrUpdate" id="superform" style="">

  <input type="hidden" name="RECORD_ID" value="${source.RECORD_ID}">
<div class="form-group" compcode="formgroup">
   <plattag:input name="SOURCE_NAME" allowblank="false" auth_type="write" value="${source.SOURCE_NAME}" datarule="required;chinese;" maxlength="58" label_value="督办来源" placeholder="请输入督办来源" comp_col_num="6" label_col_num="3">
   </plattag:input>
</div>
<div class="hr-line-dashed"></div><div class="form-group" compcode="formgroup">
   <plattag:input name="FILE_NAME" allowblank="true" auth_type="write" value="${source.FILE_NAME}" maxlength="118" label_value="文件名" placeholder="请输入文件名" comp_col_num="6" label_col_num="3">
   </plattag:input>
</div>
<div class="hr-line-dashed"></div><div class="form-group" compcode="formgroup">
   <plattag:textarea name="REMARKS" allowblank="true" auth_type="write" value="${source.REMARKS}" maxlength="248" label_value="备注信息" placeholder="请输入备注信息" comp_col_num="6" label_col_num="3">
   </plattag:textarea>
...
<div class="hr-line-dashed"></div><div class="form-group" compcode="formgroup">
   <plattag:radio name="DEL_FLAG" allowblank="true" auth_type="write" value="${source.DEL_FLAG}" select_first="true" is_horizontal="true" label_value="删除标记" comp_col_num="6" label_col_num="3" static_values="正常:1,删除:2">
   </plattag:radio>
</div>
