...
<script type="text/javascript">
  $(function(){
	  ...
	  PlatUtil.initZtree({
		  ...
		  callback: {
			  onCheck:function(event, treeId, treeNode){
				  PlatUtil.selectedGridItem(treeId, treeNode,true,"selectedDirectorUserGrid");
			  },
			  onClick:function (e, treeId, treeNode, clickFlag) { 
				  PlatUtil.selectedGridItem(treeId, treeNode,false,"selectedDirectorUserGrid");
			  }
		  },
		  async : {
    ...
    <plattag:griditem iconfont="fa fa-address-book" dyna_interface="departService.findDeptDirectorList" dragable="false" selectedrecordids="${selectedRecordIds}" itemtplpath="common/compdesign/griditem/griditem_tpl" id="selectedDirectorUserGrid" paneltitle="已选用户列表(<font color='red'>双击可取消选择</font>)" itemconf="[SYSUSER_ID,1,用户ID][SYSUSER_NAME,-1,姓名][COMPANY_NAME,-1,单位][DEPART_NAME,-1,部门][SYSUSER_MOBILE,-1,手机号][COMPANY_ID,1,单位ID][DEPART_ID,1,部门ID]"></plattag:griditem>
</div>
...
<script type="text/javascript">
	...
	var maxselect = 1;
	var minselect = 1;
	var checkRecords = PlatUtil.getSelectedGridItem("selectedDirectorUserGrid");
    var checkIds = "";
	var checkNames = "";
	var checkCompanyIds = "";
