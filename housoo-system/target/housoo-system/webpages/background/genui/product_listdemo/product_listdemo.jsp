...
<div class="titlePanel">
	<div class="title-search form-horizontal" id="product_search" formcontrolid="4028819f71c91fe10171c92d7a6b0015">
		<table>
			<tr>
				<td>查询条件</td>
...
function addJqGridRecordInfo(PRODUCT_ID){
	var url = "demo/ProductController.do?goForm&UI_DESIGNCODE=product_formdemo";
	var title = "新增产品信息信息";
	if(PRODUCT_ID){
...
$(function(){
	PlatUtil.initJqGrid({
		  ...
		  url: "appmodel/CommonUIController.do?tabledata&FORMCONTROL_ID=4028819f71c91fe10171c92d7a6b0015",
		  ...
		  colModel: [
		         ...
		         sortable:true,index: "O_T.PRODUCT_CREATETIME"
