...
<html>
  ...
  <body>
   ...
   <div class="titlePanel">
	<div class="title-search form-horizontal" id="supervisesourcetable_search" formcontrolid="4028819f71e7841f0171e788a8270013">
		<table>
			<tr>
				<td>查询条件</td>
					...
					<div class="table-filter">
						...
						<div class="table-filter-list" style="width: 420px; display: none;max-height: 280px;">
								<div class="form-group">
									<plattag:input name="Q__LIKE" auth_type="write" label_value="督办来源" maxlength="100" allowblank="true" placeholder="" label_col_num="3" comp_col_num="9"></plattag:input>
								</div>
...
function addJqGridRecordInfo(RECORD_ID){
	var url = "supervise/SourceController.do?goForm&UI_DESIGNCODE=su_source_form";
	var title = "新增督办来源信息";
	if(RECORD_ID){
...
$(function(){
	PlatUtil.initJqGrid({
		  ...
		  url: "appmodel/CommonUIController.do?tabledata&FORMCONTROL_ID=4028819f71e7841f0171e788a8270013",
