...
<head>
    ...
    <script type="text/javascript" src="webpages/background/supervise/assets/js/supEndList.js"></script>
...
<script type="text/javascript" src="assets/js/b.tabs.min.js"></script>
