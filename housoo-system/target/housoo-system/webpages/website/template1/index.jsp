...
<link rel="stylesheet"
	href="webpages/website/template1/assets/css/index.min.css" />
</head>
<body>
	<div class="layout">
		<!--===========layout-header================-->
					...
					<div class="am-g">
						...
						<div class="am-u-md-9">
							<div class="topbar-right am-text-right am-fr">
								...
								<i class="am-icon-rss"></i> <a href="html/login.html">登录</a> <a
									href="html/register.html">注册</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="header">
						<div class="am-g">
							<div class="am-u-lg-2 am-u-sm-12">
								<div class="logo">
									<a href=""><img
										src="webpages/website/template1/assets/images/logo.png" alt="" /></a>
								</div>
							</div>
				...
				<div class="nav-contain">
					<div class="nav-inner">
						<ul class="am-nav am-nav-pills am-nav-justify">
							...
							<li><a href="html/news.html">新闻中心</a> <!-- sub-menu start-->
								<ul class="sub-menu">
									...
									<ul class="am-menu-nav am-avg-sm-1">
										...
										<li class="am-parent"><a href="#" class="">产品中心</a>
											<ul class="am-menu-sub am-collapse ">
												<li class=""><a href="html/product1.html" class="">产品展示1</a>
												</li>
												<li class=""><a href="html/product2.html" class="">产品展示2</a>
												</li>
												<li class=""><a href="html/product3.html" class="">产品展示3</a>
												</li>
											</ul></li>
										<li class=""><a href="html/example.html" class="">客户案例</a></li>
										<li class=""><a href="html/solution.html" class="">解决方案</a></li>
										<li class="am-parent"><a href="html/news.html" class="">新闻中心</a>
											<ul class="am-menu-sub am-collapse  ">
												<li class=""><a href="html/news-content.html" class="">公司动态</a>
												</li>
												<li class=""><a href="html/404-dark.html" class="">行业动态</a>
												</li>
												<li class=""><a href="html/404-light.html" class="">精彩专题</a>
												</li>
											</ul></li>
					...
					<div class="am-g">
						<div class="am-u-md-3">
							<div class="features_item">
								<img
									src="webpages/website/template1/assets/images/index/f01.jpg"
									alt="">
						...
						<div class="am-u-md-3">
							<div class="features_item">
								<img
									src="webpages/website/template1/assets/images/index/f02.jpg"
									alt="">
						...
						<div class="am-u-md-3">
							<div class="features_item">
								<img
									src="webpages/website/template1/assets/images/index/f03.jpg"
									alt="">
						...
						<div class="am-u-md-3">
							<div class="features_item">
								<img
									src="webpages/website/template1/assets/images/index/f04.jpg"
									alt="">
				...
				<div class="am-g">
					<div class="am-u-md-6">
						<ul class="promo_detailed--list">
							...
							<li class="promo_detailed--list_item"><span
								class="promo_detailed--list_item_icon"> <i
									class="am-icon-dollar" style="margin-left: 15px;"></i>
							</span>
								<dl>
									<dt>丰富的日志报表系统</dt>
							...
							<li class="promo_detailed--list_item"><span
								class="promo_detailed--list_item_icon"> <i
									class="am-icon-bank" style="margin-left: 10px;"></i>
							</span>
								<dl>
									<dt>丰富的应用程序管理</dt>
					...
					<div class="am-u-md-6">
						<div class="promo_detailed--cta">
							...
							<div class="promo_detailed-img am-show-sm-only"
								style="background-image: url('webpages/website/template1/assets/images/index/promo_detailed_bg.jpg');"></div>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="pricing_compare">
				<ul class="pricing_compare--options">
					<li class="pricing_compare--option"><i
						class="pricing_compare--option_icon am-icon-group"></i>Company
						Size</li>
					<li class="pricing_compare--option"><i
						class="pricing_compare--option_icon am-icon-umbrella"></i>Insurance
						Coverage</li>
					<li class="pricing_compare--option"><i
						class="pricing_compare--option_icon am-icon-life-ring"></i>Number
						of Consultations</li>
					<li class="pricing_compare--option"><i
						class="pricing_compare--option_icon am-icon-street-view"></i>Phone
						Support</li>
					<li class="pricing_compare--option"><i
						class="pricing_compare--option_icon am-icon-dollar"></i>Investments
						Protection</li>
				</ul>
				<div class="pricing_compare--plans">
					<div class="pricing_plan">
						<header class="pricing_plan--header">
							<h2 class="pricing_plan--title">
								<b>BASIC </b>PLAN
							</h2>
							<strong class="pricing_plan--price">$69<small>/m</small></strong>
						</header>
					...
					<div class="pricing_plan popular">
						<header class="pricing_plan--header">
							<span class="pricing_plan--label popular">Popular</span>
							<h2 class="pricing_plan--title">
								<b>plus </b>PLAN
							</h2>
							<strong class="pricing_plan--price">$99<small>/m</small></strong>
						</header>
						<ul class="pricing_plan--options">
					...
					<div class="pricing_plan">
						<header class="pricing_plan--header">
							...
							<strong class="pricing_plan--price"><small>Custom</small></strong>
						</header>
						<ul class="pricing_plan--options">
			...
			<div class="am-g">
				<div class="am-u-md-2 am-u-sm-4 customer-box">
					<a href="#"> <img class="normal-logo"
						src="webpages/website/template1/assets/images/index/customer_logo_Microsoft.png"
						alt="" /> <img class="am-active" alt=""
						src="webpages/website/template1/assets/images/index/customer_logo_Microsoft_active.png"
						alt="" />
					</a>
				</div>
				<div class="am-u-md-2 am-u-sm-4 customer-box">
					<a href="#"> <img class="normal-logo"
						src="webpages/website/template1/assets/images/index/customer_logo_qhdx.png"
						alt="" /> <img class="am-active"
						src="webpages/website/template1/assets/images/index/customer_logo_qhdx_active.png"
						alt="" />
					</a>
				</div>
				<div class="am-u-md-2 am-u-sm-4 customer-box">
					<a href="#"> <img class="normal-logo"
						src="webpages/website/template1/assets/images/index/customer_logo_gmw.png"
						alt="" /> <img class="am-active"
						src="webpages/website/template1/assets/images/index/customer_logo_gmw_active.png"
						alt="" />
					</a>
				</div>
				<div class="am-u-md-2 am-u-sm-4 customer-box">
					<a href="#"> <img class="normal-logo"
						src="webpages/website/template1/assets/images/index/customer_logo_gov.png"
						alt="" /> <img class="am-active"
						src="webpages/website/template1/assets/images/index/customer_logo_gov_active.png"
						alt="" />
					</a>
				</div>
				<div class="am-u-md-2 am-u-sm-4 customer-box">
					<a href="#"> <img class="normal-logo"
						src="webpages/website/template1/assets/images/index/customer_logo_jl.png"
						alt="" /> <img class="am-active"
						src="webpages/website/template1/assets/images/index/customer_logo_jl_active.png"
						alt="" />
					</a>
				</div>
				<div class="am-u-md-2 am-u-sm-4 customer-box">
					<a href="#"> <img class="normal-logo"
						src="webpages/website/template1/assets/images/index/customer_logo_hx.png"
						alt="" /> <img class="am-active"
						src="webpages/website/template1/assets/images/index/customer_logo_hx_active.png"
						alt="" />
					</a>
				</div>
			</div>
	...
	<div class="section"
		style="margin-top:0px;background-image: url('webpages/website/template1/assets/images/pattern-light.png');">
		<div class="container">
			<!--index-container start-->
			<div class="index-container">
				<div class="am-g">
