select T.RES_ID,T.RES_NAME,T.RES_MENUURL,T.RES_MENUICON from PLAT_SYSTEM_RES T 
WHERE  T.RES_STATUS = '1' AND T.RES_LEVEL=? AND T.RES_CODE IN (select R.RES_CODE from PLAT_SYSTEM_RES R WHERE R.RES_STATUS = '1' AND R.RES_ID IN (
