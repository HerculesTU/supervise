...
<%
    ...
    if (feedback != null) {
        request.setAttribute("FEEDBACK_ID", feedback.get("RECORD_ID"));
    }
                ...
                <div class="af-foot">
                    <c:if test="${not empty feedback}">
                        <button type="button" class="search_btn"
                                onclick="approveSupervise('确认退回？','2','${FEEDBACK_ID}');">退回
                        </button>
                        <button type="button" style="background-color: #1ab370" class="search_btn"
                                onclick="approveSupervise('确认同意？','1','${FEEDBACK_ID}');">同意
                        </button>
                    </c:if>
                </div>
            </form>
...
<script type="text/javascript" src="webpages/background/supervise/assets/js/approve.js"></script>
</body>
</html>
<script>
    $(function () {
