                    ...
                    <div class="col-3 fl">
                        ...
                        <div class="cbom">
                            <ul>
                                ...
                                <li>
                                    <p>督办确认</p>
                                    <p class="p2 color3" id="dbqr">0</p>
                                </li>
                                <li>
                                    <p>办理反馈</p>
                                    <p class="p2 color2" id="blfk">0</p>
                                </li>
                                <li>
                                    <p>办结反馈</p>
                                    <p class="p2 color4" id="bjfk">0</p>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<script type="text/javascript" src="webpages/background/supervise/assets/js/lineArea.js"></script>
<script type="text/javascript" src="webpages/background/supervise/assets/js/pieChartsNew.js"></script>
<script type="text/javascript" src="webpages/background/supervise/assets/js/sponsorIndex.js"></script>
